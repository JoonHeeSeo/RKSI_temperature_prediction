...
EPOCHS    = 50
LR        = 1e-3
CHECKPT   = "checkpoints/best_gru.pth"
...
model = GRUModel(input_size=input_size, hidden_size=64, num_layers=2, dropout=0.1).to(device)
...
print(f"\n▶ GRU Test MAE: {mae:.2f} ℃, RMSE: {rmse:.2f} ℃")
